...
def main():
    ...
    if _resolved_pod:
        _log(f"qualys-mcp v0.3.0 — POD={_resolved_pod}  BASE_URL={BASE_URL}  GATEWAY_URL={GATEWAY_URL}")
    else:
        _log(f"qualys-mcp v0.3.0 — BASE_URL={BASE_URL}  GATEWAY_URL={GATEWAY_URL}")
